...
//Date        : Mon Aug  9 04:47:08 2021
//Host        : DESKTOP-1CR47K2 running 64-bit major release  (build 9200)
...
module BRAM
   (BRAM_PORTA_0_addr,
    ...
    BRAM_PORTA_0_en,
    BRAM_PORTA_0_we);
  (* X_INTERFACE_INFO = "xilinx.com:interface:bram:1.0 BRAM_PORTA_0 ADDR" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME BRAM_PORTA_0, MASTER_TYPE OTHER, MEM_ECC NONE, MEM_SIZE 8192, MEM_WIDTH 32, READ_LATENCY 1, READ_WRITE_MODE READ_WRITE" *) input [12:0]BRAM_PORTA_0_addr;
